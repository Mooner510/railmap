{
  echo "[1/4] observed schema 출력 기능 추가 중..." >&2
...
EOF
  ...
  echo "[3/4] 생성 파일 확인 중..." >&2
  sed -n '1,220p' data/observed/2026-06-19/kric/kric-urban-rail-observed-schema.json

  echo "[4/4] 완료" >&2
} | tee /dev/stderr | pbcopy

echo "완료: 실행 결과가 클립보드에 복사됐습니다. 붙여넣어 주세요."
